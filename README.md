...
This repository contains **lecture slides, unit tests, reference materials, and additional learning resources** for the course **Cloud Computing and Security**.
...
Students can experiment using cloud simulation tools:

| Tool | Link |
|----|----|
| CloudSim | https://www.cloudbus.org/cloudsim/ |
| CloudAnalyst | https://www.cloudbus.org/cloudsim/cloudanalyst/ |
| GreenCloud | https://greencloud.gforge.uni.lu/ |

---

# ⭐ Contributions

Students can contribute by sharing sharing it via email:
